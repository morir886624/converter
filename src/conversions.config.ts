...
export const conversions: ConversionDef[] = [
  ...
  },
  {
    ...
    to: 'jpg',
    category: 'image',
    title: 'Convertir SVG en JPG gratuitement',
    description: 'Convertissez vos fichiers SVG en image JPEG pour les partager sur des plateformes ne supportant pas le format vectoriel. Conversion instantanée dans votre navigateur.',
    specificFaq: {
      question: 'Le fond transparent du SVG devient-il blanc en JPG ?',
      answer: 'Oui. Le format JPEG ne supporte pas la transparence, le fond transparent est donc remplacé par du blanc lors de la conversion.',
    },
  },
  {
    slug: 'bmp-en-png',
    ...
    to: 'png',
    category: 'image',
    title: 'Convertir BMP en PNG gratuitement',
    description: 'Convertissez vos images BMP volumineuses en PNG compressé sans perte. Idéal pour réduire la taille des captures d\'écran et images Windows.',
  },
  {
    slug: 'jpg-en-bmp',
    from: 'jpg',
    to: 'bmp',
    category: 'image',
    title: 'Convertir JPG en BMP gratuitement',
    description: 'Transformez vos images JPEG en BMP pour les utiliser dans des applications Windows et logiciels qui requièrent le format bitmap non compressé.',
  },
  {
    slug: 'pdf-en-webp',
    from: 'pdf',
    ...
    description: 'Extrayez chaque page d\'un PDF en image WebP ultra-compressée, idéale pour le web. Chaque page devient un fichier WebP optimisé.',
  },
  // ── Audio ─────────────────────────────────────────────────────────────────
  {
    slug: 'gif-en-mp4',
    ...
    to: 'mp4',
    category: 'video',
    title: 'Convertir GIF en MP4 gratuitement',
    description: 'Transformez vos GIF animés en vidéo MP4 pour une taille de fichier jusqu\'à 10× plus petite, compatible avec tous les appareils et réseaux sociaux.',
    specificFaq: {
      question: 'Pourquoi convertir un GIF en MP4 ?',
      answer: 'Le MP4 H.264 compresse bien mieux que le GIF : une vidéo MP4 équivalente est souvent 5 à 10 fois plus légère, ce qui accélère considérablement le chargement des pages web.',
    },
  },
  {
    slug: 'ogg-en-mp3',
    ...
    to: 'mp3',
    category: 'audio',
    title: 'Convertir OGG en MP3 gratuitement',
    description: 'Convertissez vos fichiers audio OGG Vorbis en MP3 universel, compatible avec tous les lecteurs audio, smartphones et plateformes de streaming.',
  },
  {
    slug: 'flac-en-mp3',
    from: 'flac',
  ...
  },
  {
    ...
    to: 'wav',
    category: 'audio',
    title: 'Convertir FLAC en WAV gratuitement',
    description: 'Transformez vos fichiers FLAC en WAV non compressé pour une compatibilité maximale avec les logiciels de montage audio professionnels.',
  },
  {
    slug: 'm4a-en-aac',
    from: 'm4a',
    to: 'aac',
    category: 'audio',
    title: 'Convertir M4A en AAC gratuitement',
    description: 'Extrayez le flux AAC pur depuis vos fichiers M4A Apple pour une compatibilité optimale avec les appareils Android et les plateformes de streaming.',
  },
  // ── Video ─────────────────────────────────────────────────────────────────
  {
    slug: 'avi-en-mp4',
  ...
  },
  {
    ...
    to: 'yaml',
    category: 'data',
    title: 'Convertir JSON en YAML gratuitement',
    description: 'Transformez vos données JSON en fichier YAML lisible, idéal pour les fichiers de configuration Kubernetes, Docker Compose ou CI/CD.',
    specificFaq: {
      question: 'YAML est-il meilleur que JSON pour la configuration ?',
      answer: 'YAML est plus lisible par l\'humain (pas de guillemets ni accolades), ce qui le rend idéal pour les fichiers de configuration. JSON est préférable pour les APIs et échanges entre machines.',
    },
  },
  {
    slug: 'xlsx-en-json',
    ...
    to: 'json',
    category: 'data',
    title: 'Convertir Excel XLSX en JSON gratuitement',
    description: 'Transformez vos classeurs Excel en tableau JSON prêt à utiliser dans une API ou application web. La première feuille est convertie avec les en-têtes comme clés.',
    specificFaq: {
      question: 'Les formules Excel sont-elles calculées dans le JSON ?',
      answer: 'Oui. Les valeurs calculées par les formules sont exportées dans le JSON, mais les formules elles-mêmes ne sont pas incluses.',
    },
  },
  {
    slug: 'csv-en-xml',
    ...
    to: 'xml',
    category: 'data',
    title: 'Convertir CSV en XML gratuitement',
    description: 'Transformez vos fichiers CSV tabulaires en XML structuré, compatible avec les systèmes ERP, EDI et les pipelines de données d\'entreprise.',
  },
  {
    slug: 'xml-en-csv',
    from: 'xml',
    to: 'csv',
    category: 'data',
    title: 'Convertir XML en CSV gratuitement',
    description: 'Extrayez les données d\'un fichier XML et exportez-les en CSV tabulaire, directement analysable dans Excel, Google Sheets ou Python.',
  },
];
